<script lang="ts">
  ...
  import { type OtherConsumable } from "$lib/data/consumables";

  export let playerData: PlayerData;
  export let consumable: OtherConsumable;
  export let editable: boolean;

  // Amount of the consumable
  $: amount = playerData.base.inventory[consumable.index] ?? 0;
</script>
    ...
    <div class="weapon">
      ...
      <div class="weapon__details">
        <div class="weapon__details__head">
          ...
          <span class="weapon__level">{amount}</span>
        </div>
        {#if editable}
          <div class="input">
