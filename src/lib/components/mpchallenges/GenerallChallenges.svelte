<script lang="ts">
    import { CHALLENGE_TYPES_GENERAL } from "$lib/data/challenges";
    ...
    function isMassEffectOrSquadElite(challengeName: string): boolean {
        return (
            "Mass Effect" === challengeName || "Squad Elite" === challengeName
        );
...
<ChallengesList tabs={CHALLENGE_TYPES_GENERAL} let:selected>
    {#if isMassEffectOrSquadElite(selected.name)}
            ...
            <div class={getCardClassType(i)}>
                ...
                <div class="inv-card__value">
                    ...
                    <span class="annot">
                        ...
                        <li>
                            <!-- TODO read rawdata from cscomplete. If challenge is complete then set progress to 100% (also the progress bar)
                             Else: usual behavior like below
                            -->
