...
// Structure for defining a type of game visibility
 ...
 */
function getVisibility(attributes: Attrs): Visibility {
...
// Structure for defining a type of enemy
interface Enemy {
